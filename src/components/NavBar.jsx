...
export default function NavBar() {
  ...
  return (
    <>
      <div
        className={`w-full ${
          scrolled ? 'bg-indigo-400/70' : 'bg-indigo-400'
        } px-6 h-20 bg-indigo-400 text-white flex items-center justify-between fixed top-0 left-0 z-50`}
      >
        <div className="px-2 h-full hidden items-center justify-center lg:flex">
          <Image
            className="inline-block h-18 w-12 rounded-full ring-2 ring-white"
            src="/logo.png"
            alt="Logo"
            width={40}
            height={100}
